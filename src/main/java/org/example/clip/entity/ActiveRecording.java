...
public class ActiveRecording extends PanacheEntityBase {
    ...
    /**
     * Kanalın DVR'ı kapalıyken bu kayıt için mi açıldı.
     *
     * <p>Durdurulduğunda geri kapatabilmek için tutuluyor; bkz.
     * {@link org.example.clip.ChannelRecordingGate}.
     */
    ...
    /** Bu kanalda kaydı kendisi açmış, hâlâ süren manuel kayıt var mı. */
    public static boolean anyTemporaryOn(java.util.UUID channelId) {
        return count("channel.id = ?1 and dvrBizden = true", channelId) > 0;
    }
}
